...
#ifndef AGILV8_GLUNIFORM2FVFUNC_H
#define AGILV8_GLUNIFORM2FVFUNC_H

#include "v8.h"

auto glUniform2fvFunc = [](const v8::FunctionCallbackInfo<v8::Value> &args) {
    ...
    glUniform2fv(location, count, floats);
};

#endif //AGILV8_GLUNIFORM2FVFUNC_H
